package com.company.jmixonboarding.test_support;

import com.company.jmixonboarding.JmixOnboardingApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.jmixonboarding.screen")
@ContextConfiguration(classes = {JmixOnboardingApplication.class, UiTestAssistConfiguration.class})
